...
This declaration governs `ndrorchestration/Acoustic-mesh` — a WebRTC phi-harmonic acoustic mesh network. All audio routing logic, mesh networking protocols, and phi-harmonic outputs produced by this repository are governed under the DGAF Framework protocols below.
